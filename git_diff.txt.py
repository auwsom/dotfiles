...
index f3dff50..75cc814 100644
--- a/.bash_aliases
+++ b/.bash_aliases
@@ -787,30 +787,9 @@ alias gitc='git commit -m "ok"'
...
->>>>>>> d638d4a ("ok")
 ...
 setup a repo from local:
diff --git a/.bash_aliases-parked b/.bash_aliases-parked
deleted file mode 100644
index 0d1d271..0000000
--- a/.bash_aliases-parked
+++ /dev/null
@@ -1,964 +0,0 @@
...
-ENDZ
diff --git a/.bash_aliases-work b/.bash_aliases-work
deleted file mode 100644
index 8d3ead4..0000000
--- a/.bash_aliases-work
+++ /dev/null
@@ -1,971 +0,0 @@
-## WARNING: Never run a script from the internet without reading and understanding it (see last line of file).
...
-ENDZ
-
diff --git a/.git_diff.txt.py.kate-swp b/.git_diff.txt.py.kate-swp
deleted file mode 100644
index 3985981..0000000
Binary files a/.git_diff.txt.py.kate-swp and /dev/null differ
diff --git a/autostart-moved-to-crontab-runs-autostart-scripts b/autostart-moved-to-crontab-runs-autostart-scripts
deleted file mode 100644
index e69de29..0000000
diff --git a/autostart-scripts-off/git_auto_sync b/autostart-scripts-off/git_auto_sync
deleted file mode 100755
index f62756b..0000000
--- a/autostart-scripts-off/git_auto_sync
+++ /dev/null
@@ -1,11 +0,0 @@
-#!/bin/bash
-
...
-
-
diff --git a/autostart-scripts-off/konsole_watcher.sh-old b/autostart-scripts-off/konsole_watcher.sh-old
deleted file mode 100755
index 9fd71ba..0000000
--- a/autostart-scripts-off/konsole_watcher.sh-old
+++ /dev/null
@@ -1,40 +0,0 @@
-#!/bin/bash
-
...
diff --git a/autostart-scripts-off/konsole_watcher.sh.desktop b/autostart-scripts-off/konsole_watcher.sh.desktop
deleted file mode 100755
index 09f6bab..0000000
--- a/autostart-scripts-off/konsole_watcher.sh.desktop
+++ /dev/null
@@ -1,8 +0,0 @@
-#cp konsole_watcher.sh.desktop /home/user/.config/autostart/
-[Desktop Entry]
-Exec=/home/user/.config/autostart-scripts/konsole_watcher.sh
-Icon=dialog-scripts
-Name=konsole_watcher.sh
-Path=
-Type=Application
-X-KDE-AutostartScript=true
diff --git a/autostart-scripts-off/mouse_move.sh b/autostart-scripts-off/mouse_move.sh
deleted file mode 100755
index 1406b17..0000000
--- a/autostart-scripts-off/mouse_move.sh
+++ /dev/null
@@ -1,12 +0,0 @@
-#!/bin/bash
-
...
diff --git a/autostart-scripts/applications-startup.sh b/autostart-scripts/applications-startup.sh
deleted file mode 100755
index c76322b..0000000
--- a/autostart-scripts/applications-startup.sh
+++ /dev/null
@@ -1,4 +0,0 @@
-#!/bin/bash
-
...
diff --git a/checkip.sh b/checkip.sh
deleted file mode 100755
index 124f445..0000000
--- a/checkip.sh
+++ /dev/null
@@ -1,5 +0,0 @@
-#!/bin/bash
...
diff --git a/crontab/check-space.sh b/crontab/check-space.sh
deleted file mode 100755
index 34d09da..0000000
--- a/crontab/check-space.sh
+++ /dev/null
@@ -1,2 +0,0 @@
-#!/bin/bash
...
diff --git a/crontab/clamscan_daily.sh b/crontab/clamscan_daily.sh
deleted file mode 100755
index 69424fa..0000000
--- a/crontab/clamscan_daily.sh
+++ /dev/null
@@ -1,7 +0,0 @@
-#!/bin/bash
-
...
diff --git a/crontab/crontab-p b/crontab/crontab-p
deleted file mode 100644
index 51dfc61..0000000
--- a/crontab/crontab-p
+++ /dev/null
@@ -1,44 +0,0 @@
...
-
diff --git a/crontab/crontab1 b/crontab/crontab1
deleted file mode 100644
index 977aed8..0000000
--- a/crontab/crontab1
+++ /dev/null
@@ -1,83 +0,0 @@
-# Edit this file to introduce tasks to be run by cron.
...
-@hourly cronic /home/user/dotfiles/crontab/check-space.sh        # every hour on the hour
...
-
-
-0 6 * * * /bin/bash -c '. /root/.env; /usr/bin/canonical-livepatch enable "$LPTOKEN"'
-0 7 * * * /usr/bin/canonical-livepatch disable
-
-
diff --git a/crontab/dotfiles-notification.sh b/crontab/dotfiles-notification.sh
deleted file mode 100755
index 2cc2001..0000000
--- a/crontab/dotfiles-notification.sh
+++ /dev/null
@@ -1,10 +0,0 @@
-#!/bin/bash
-
...
diff --git a/crontab/email_test.sh b/crontab/email_test.sh
deleted file mode 100755
index abaf1d6..0000000
--- a/crontab/email_test.sh
+++ /dev/null
@@ -1,3 +0,0 @@
-#!/bin/bash
-source /root/.env
-mail -s "email test on: $(hostname)" $EMAIL <<< "email test"
diff --git a/crontab/jo_alerts.sh b/crontab/jo_alerts.sh
deleted file mode 100755
index cd039c6..0000000
--- a/crontab/jo_alerts.sh
+++ /dev/null
@@ -1,5 +0,0 @@
-#!/bin/bash
-
...
-
diff --git a/crontab/old/backup-smart-old b/crontab/old/backup-smart-old
deleted file mode 100644
index 8c6bb26..0000000
--- a/crontab/old/backup-smart-old
+++ /dev/null
@@ -1,70 +0,0 @@
-#!/bin/bash
...
-END
-
diff --git a/crontab/old/git-sync b/crontab/old/git-sync
deleted file mode 100755
index 8598765..0000000
--- a/crontab/old/git-sync
+++ /dev/null
@@ -1,384 +0,0 @@
-#!/usr/bin/env bash
-#
...
-	;;
-esac
diff --git a/crontab/old/git-sync-on-inotify b/crontab/old/git-sync-on-inotify
deleted file mode 100755
index 5eacbc8..0000000
--- a/crontab/old/git-sync-on-inotify
+++ /dev/null
@@ -1,39 +0,0 @@
-#!/usr/bin/env bash
-
...
-	fi
-done
diff --git a/crontab/old/github-daily b/crontab/old/github-daily
deleted file mode 100755
index c6e13cc..0000000
--- a/crontab/old/github-daily
+++ /dev/null
@@ -1,5 +0,0 @@
-#!/bin/bash
-echo $(date +%F) >> /home/user/git/home/day
-su user -c "cd ~/git/home && git add . && git commit -m commit && git push -u origin main"
-# su user -c "cd ~/git/dotfiles && git add . && git commit -m commit && git push -u origin main"
-
diff --git a/crontab/old/mybackup-usb-old b/crontab/old/mybackup-usb-old
deleted file mode 100755
index 8a4b3d9..0000000
--- a/crontab/old/mybackup-usb-old
+++ /dev/null
@@ -1,15 +0,0 @@
-#!/bin/bash
-set -o errexit -o nounset -o xtrace
-
-#rsync -aAX --info=progress2 /media/user/16GBa/TinyLinux-2018-10-28 /media/user/backups/usb/TinyLinux-2018-10-28_$(date +%F--%T)
-
-dir="/media/user/backups/usb"
-file="/media/user/16GBa/TinyLinux-2018-10-28"
-#if ! [[ $ls -A $dir/$1 ]] && rsync -aAX --info=progress2 $file $dir/$1/${file##*/}_$(date +%F--%T)
-
-dir="/media/user/backups/backup-work"
-file="/media/user/VM/ubuntu-20.04-server-cloudimg-amd64-disk-kvm--kub-set3--work-bak2.qcow2"
-#if ! [[ $ls -A $dir/$1 ]] && rsync -aAX --info=progress2 $file $dir/$1/${file##*/}_$(date +%F--%T)
-
-
-
diff --git a/crontab/rtb_smart_backups.sh b/crontab/rtb_smart_backups.sh
deleted file mode 100755
index 6a3ed1e..0000000
--- a/crontab/rtb_smart_backups.sh
+++ /dev/null
@@ -1,46 +0,0 @@
-#!/bin/bash
-
...
diff --git a/crontab/snap_clean.sh b/crontab/snap_clean.sh
deleted file mode 100755
index 432c0d6..0000000
--- a/crontab/snap_clean.sh
+++ /dev/null
@@ -1,2 +0,0 @@
-#!/bin/bash
...
diff --git a/git_diff.txt.py b/git_diff.txt.py
deleted file mode 100644
index 1bdbcff..0000000
--- a/git_diff.txt.py
+++ /dev/null
@@ -1,224 +0,0 @@
-diff --git a/.bash_aliases b/.bash_aliases
...
- true <<'ENDZ' # move this line to anywhere above and whatever is below it will be skipped.
- ENDZ
diff --git a/rsync_tmbackup2.sh b/rsync_tmbackup2.sh
deleted file mode 100644
index 45306b9..0000000
--- a/rsync_tmbackup2.sh
+++ /dev/null
@@ -1,727 +0,0 @@
-#!/usr/bin/env bash
-
...
-    exit 0
-done
diff --git a/rsync_tmbackup3.sh b/rsync_tmbackup3.sh
deleted file mode 100755
index 108a3e2..0000000
--- a/rsync_tmbackup3.sh
+++ /dev/null
@@ -1,597 +0,0 @@
-#!/usr/bin/env bash
-
...
-    break
-done
diff --git a/rsync_tmbackup3.sh-bak b/rsync_tmbackup3.sh-bak
deleted file mode 100755
index 33fd401..0000000
--- a/rsync_tmbackup3.sh-bak
+++ /dev/null
@@ -1,582 +0,0 @@
-#!/usr/bin/env bash
-
...
-    break
-done
diff --git a/test-notif.sh b/test-notif.sh
deleted file mode 100755
index 8f1555a..0000000
--- a/test-notif.sh
+++ /dev/null
@@ -1,2 +0,0 @@
-#!/bin/bash
