...
alias lns='ln -s' # <symlink> <destination>.hardlinks accumulate and dont work across disks. rm symlink wont remove underlying file. see function lnsr for reversed args
