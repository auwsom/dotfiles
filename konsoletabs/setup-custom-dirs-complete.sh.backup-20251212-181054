...
echo "Window 2 (aimgr): Position ($WINDOW2_X,$WINDOW_START_Y) - 3 tabs in ~/dev/avoli/agent3"
echo "Window 3 (aimgr): Position ($WINDOW3_X,$WINDOW_START_Y) - 3 tabs in ~/dev/avoli/agent3"
...
echo "Window 2 (aimgr): 3 tabs in ~/dev/avoli/agent3"
echo "Window 3 (aimgr): 3 tabs in ~/dev/avoli/agent3"
