...
/home/user/git/dotfiles/rsync_tmbackup3.sh  -s /media/user/16GBa -d /media/user/backups/rtb-usb/ 
...
# /home/user/git/dotfiles/rsync_tmbackup3.sh  -s /home/user -d /media/user/backups/rtb-home-user/ --rsync-append-flags "--exclude .cache"
/home/user/git/dotfiles/rsync_tmbackup3.sh  -s /home/user -d /media/user/backups/rtb-home-user/ --ex ".cache"
...
/home/user/git/dotfiles/rsync_tmbackup3.sh  -s /media/user/VM/25G-p -d /media/user/backups/rtb-pers/ 

/home/user/git/dotfiles/rsync_tmbackup3.sh  -s /media/user/VM/100G-w -d /media/user/backups2/rtb-work/ --strategy "1:14 14:90 90:365 3650:3650"
/home/user/git/dotfiles/rsync_tmbackup3.sh  -s /media/user/ai/ubuntu-20.04-server-cloudimg-amd64-disk-kvm--kub-set3-2404--claude12.qcow2 -d /media/user/backups2/rtb-ai/ --strategy "1:14 14:90 90:365 3650:3650"
